...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_no3/Instructions.html'
    instructions_beliefs = 'p2_no3/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_no3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_no3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_no3/Instbeliefyesno.html'
    ...
    with open('p2_no3/imp_p1_no3_c.csv', 'r') as f:
        reader = csv.reader(f)
