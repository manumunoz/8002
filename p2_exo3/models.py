...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_exo3/Instructions.html'
    instructions_beliefs = 'p2_exo3/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_exo3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_exo3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_exo3/Instbeliefyesno.html'
    ...
    with open('p2_exo3/imp_p1_exo3_b.csv', 'r') as f:
        reader = csv.reader(f)
