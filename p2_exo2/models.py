...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_exo2/Instructions.html'
    instructions_beliefs = 'p2_exo2/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_exo2/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_exo2/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_exo2/Instbeliefyesno.html'
    ...
    with open('p2_exo2/imp_p1_exo2_b.csv', 'r') as f:
        reader = csv.reader(f)
