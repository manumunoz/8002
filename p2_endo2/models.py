...
doc = """
Web of Lies P2_ENDO2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P2_endo2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_endo2/Instructions.html'
    instructions_beliefs = 'p2_endo2/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_endo2/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_endo2/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_endo2/Instbeliefyesno.html'
    ...
    with open('p2_endo2/imp_p1_endo2_b.csv', 'r') as f:
        reader = csv.reader(f)
