...
doc = """
Web of Lies 3-player: Player 2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_3Study_P2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'three_p2/Instructions.html'
    instructions_beliefs = 'three_p2/InstructionsBeliefs.html'
    instructions_belief_number = 'three_p2/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'three_p2/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'three_p2/Instbeliefyesno.html'
    exo_prob_show = 80 # Complete for EXO once ENDO is conducted
    exo_prob_no_show = 20 # Complete for EXO once ENDO is conducted

    imp_rnum_T1 = [7, 1, 10, 28, 14, 20, 4, 10] # Update after P1
    imp_rnum_T2 = [9, 13, 19, 6, 25, 16, 2, 16] # Update after P1
    imp_rnum_T3 = [4, 5, 21, 23, 11, 16, 9, 30] # Update after P1
    imp_rnum_T4 = [3, 2, 15, 5, 28, 28, 28, 6] # Update after P1
    imp_rnum_T5 = [17, 23, 26, 7, 6, 10, 25, 1] # Update after P1
    imp_rnum_T11 = [29, 6, 28, 26, 2, 30, 11, 13] # Update after P1
    ...
    imp_report1_T1 = [7, 1, 10, 28, 14, 20, 4, 10] # Update after P1
    imp_report1_T2 = [9, 13, 19, 6, 25, 16, 2, 16] # Update after P1
    imp_report1_T3 = [4, 5, 21, 23, 11, 16, 9, 30] # Update after P1
    imp_report1_T4 = [3, 2, 15, 5, 28, 28, 28, 6] # Update after P1
    imp_report1_T5 = [17, 23, 26, 7, 6, 10, 25, 1] # Update after P1
    imp_report1_T11 = [29, 6, 28, 26, 2, 30, 11, 13] # Update after P1
