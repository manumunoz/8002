...
doc = """
Web of Lies 3-player: Player 1
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_3Study_P1'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'three_p1/Instructions.html'
    instructions_beliefs = 'three_p1/InstructionsBeliefs.html'
    instructions_belief_number = 'three_p1/Instbeliefnumber.html'
    instructions_belief_yesno = 'three_p1/Instbeliefyesno.html'
