...
doc = """
Web of Lies P2_FRST3
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P2_frst3'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_frst3/Instructions.html'
    instructions_beliefs = 'p2_frst3/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_frst3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_frst3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_frst3/Instbeliefyesno.html'
    ...
    with open('p2_frst3/imp_p1_frst3_b.csv', 'r') as f:
        reader = csv.reader(f)
