...
doc = """
Web of Lies P2_ENDO3
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P2_endo3'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_endo3/Instructions.html'
    instructions_beliefs = 'p2_endo3/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_endo3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_endo3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_endo3/Instbeliefyesno.html'
    ...
    with open('p2_endo3/imp_p1_endo3_b.csv', 'r') as f:
        reader = csv.reader(f)
