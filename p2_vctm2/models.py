...
doc = """
Web of Lies P2_VCTM2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P2_vctm2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p2_vctm2/Instructions.html'
    instructions_beliefs = 'p2_vctm2/InstructionsBeliefs.html'
    instructions_belief_number = 'p2_vctm2/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p2_vctm2/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p2_vctm2/Instbeliefyesno.html'
    ...
    with open('p2_vctm2/imp_p1_vctm2_d.csv', 'r') as f:
        reader = csv.reader(f)
