...
doc = """
Web of Lies 3-player: Player 3
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_3Study_P3'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'three_p3/Instructions.html'
    instructions_beliefs = 'three_p3/InstructionsBeliefs.html'
    instructions_belief_number = 'three_p3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'three_p3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'three_p3/Instbeliefyesno.html'
